  ...
  return(
    ...
    <div className='App'>
      <Routes>
        ...
        <Route path = '/createlobby' element = {<CreateLobby socket={socket} messengerObject={messengerObject}/>}/>
        <Route path = '/joinlobby' element = {<JoinLobby messengerObject={messengerObject} socket={socket} setMyRoomID={setMyRoomID}/>}/>
        <Route path = 'lobby' element = {<Lobby chatState={chatState} messengerObject={messengerObject} currentView={currentView}/>}/>
      </Routes>
    </div>
    </BrowserRouter>
  )
